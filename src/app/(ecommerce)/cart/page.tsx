  ...
  return (
    <div className='flex p-5'>      
      ...
      <div className='flex flex-col md:flex-row w-full justify-between'>
        ...
        <div className='flex flex-col bg-[#121212] border border-[#637a91] mb-10 md:mb-20 rounded md:w-[65%] p-4 md:mt-0 mt-20'>
          ...
          <div className='flex flex-col p-2'>
            ...
            <div className='flex flex-col md:flex-row p-4 justify-between border-b border-b-[#0A84FF] gap-4 md:gap-0'>

              <div className='flex justify-center align-middle md:w-auto w-[60%] self-center md:self-start'>
                <Image src={products[0].image} style={{ width: '100%', height: 'auto' }} width={120} height={120} alt={products[0].name}/>
              </div>

              <div className='flex items-center justify-center align-middle md:w-[25%]'>
              ...
              <div className='flex md:w-[20%] items-center justify-center'>
