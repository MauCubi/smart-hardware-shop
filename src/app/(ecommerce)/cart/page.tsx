  ...
  return (
    <div className='flex p-5'>
      ...
      {/* <div className='flex justify-center w-full'>
        <div className='flex justify-center align-middle items-center rounded-2xl w-[95%] md:w-[50%] h-120 bg-[#121212]'>
          <div className='flex flex-col justify-center items-center gap-6'>
            <BsCartX  color='#0A84FF' className='text-[70px] md:text-[150px]'/>
            <h1 className='titles text-2xl md:text-4xl'>Your cart is empty!</h1>
          </div>
        </div>
      </div> */}
      ...
      <div className='flex flex-row w-full justify-between'>
        ...
        <div className='flex flex-col bg-[#121212] border border-[#637a91] mb-20 rounded w-[65%] p-4'>
          ...
          <div className='flex flex-col p-2'>
            ...
            <div className='flex flex-row p-4 justify-between border-b border-b-[#0A84FF]'>

              <div className='flex'>
                <Image src={products[0].image} width={120} height={120} alt={products[0].name}/>
              </div>

              <div className='flex items-center justify-center align-middle w-[25%]'>
            ...
            <div className='flex flex-row p-4  justify-between border-b border-b-[#0A84FF]'>
              ...
              <div className='flex'>
                <Image src={products[1].image} width={120} height={120} alt={products[0].name}/>
              </div>

              <div className='flex w-[25%] items-center justify-center align-middle'>
