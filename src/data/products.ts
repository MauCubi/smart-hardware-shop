...
export const products: Product[] = [
  ...
  { id: 3, name: "Monitor 27\" 144Hz", description: "Monitor Full HD de 27 pulgadas", price: 329, category: "Monitores", image: '/img/1024.png', stock: 15 },
  { id: 4, name: "Monitor 24\" 75Hz", description: "Monitor básico para oficina", price: 159, category: "Monitores", image: '/img/1024.png', stock: 25 },
  { id: 5, name: "Teclado Mecánico RGB", description: "Teclado con switches Blue y RGB", price: 89, category: "Periféricos", image: '/img/1024.png', stock: 35 },
  { id: 6, name: "Mouse Gamer Inalámbrico", description: "Mouse inalámbrico con DPI ajustable", price: 49, category: "Periféricos", image: '/img/1024.png', stock: 50 },
  { id: 7, name: "Auriculares Gaming", description: "Auriculares con micrófono y sonido envolvente", price: 79, category: "Periféricos", image: '/img/1024.png', stock: 30 },
  { id: 8, name: "Disco SSD 1TB NVMe", description: "Unidad SSD NVMe rápida", price: 129, category: "Almacenamiento", image: '/img/1024.png', stock: 40 },
