'use client'
import { onAddProductToCart, onClearCart, onLoadCart, onRemoveProductFromCart } from '@/store/cart/cartSlice';
        ...
        <div className='flex  xl:w-[32%]'>
          <div className='flex flex-col bg-[#121212] rounded border border-[#0A84FF] p-4 max-h-fit w-full'>
            ...
            <div className='flex justify-center p-2 mt-2'>
              <button className='titles p-3 bg-[#0A84FF] rounded cursor-pointer hover:bg-[#016edb]' onClick={ () => toCheckout() }>Continue to checkout</button>
            </div>
          </div>
        </div>
      </div>
