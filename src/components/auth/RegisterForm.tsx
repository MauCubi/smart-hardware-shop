      ...
      <div className='mb-5 flex flex-row w-full gap-3'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <input
            type='text'
            id='name'
            className={`bg-zinc-100 rounded-md text-heading  text-sm focus:outline-[#0A84FF] block w-full px-3 py-2.5 placeholder:text-body ${errors.name ? 'border border-red-500 focus:outline-red-500' : '' }`}
        ...
        <div className='flex flex-col w-full'>
          ...
          <input
            type='text'
            id='lastname'
            className='bg-zinc-100 rounded-md text-heading text-sm min-w-full focus:outline-[#0A84FF] block w-full px-3 py-2.5 placeholder:text-body'
